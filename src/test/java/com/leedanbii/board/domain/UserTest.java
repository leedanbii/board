...
public class UserTest {
    ...
    void createUser_success() {
        assertThatCode(() -> User.of("danbi1", "Password1!", "단비", passwordEncoder::encode))
    ...
    void createUser_nameTooLong_throwsException() {
        assertThatThrownBy(() ->
                User.of("danbi1", "Password1!", "이름초과테스트용", passwordEncoder::encode)
    ...
    void createUser_userIdTooShort_throwsException() {
        assertThatThrownBy(() ->
                User.of("a", "Password1!", "단비", passwordEncoder::encode)
        ).isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void createUser_userIdTooLong_throwsException() {
        ...
        assertThatThrownBy(() ->
                User.of(longId, "Password1!", "단비", passwordEncoder::encode)
        ).isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void createUser_userIdPatternInvalid_throwsException() {
        assertThatThrownBy(() ->
                User.of("1invalid", "Password1!", "단비", passwordEncoder::encode)
        ).isInstanceOf(IllegalArgumentException.class);

        assertThatThrownBy(() ->
                User.of("inva#lid$", "Password1!", "단비", passwordEncoder::encode)
        ).isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void createUser_passwordTooShort_throwsException() {
        assertThatThrownBy(() ->
                User.of("danbi1", "Ab1!", "단비", passwordEncoder::encode)
        ).isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void createUser_passwordPatternInvalid_throwsException() {
        // 숫자 없음
        assertThatThrownBy(() ->
                User.of("danbi1", "Abcdefgh!", "단비", passwordEncoder::encode)
        ).isInstanceOf(IllegalArgumentException.class);

        // 특수문자 없음
        assertThatThrownBy(() ->
                User.of("danbi1", "Abcd1234", "단비", passwordEncoder::encode)
        ).isInstanceOf(IllegalArgumentException.class);

        // 알파벳 없음
        assertThatThrownBy(() ->
                User.of("danbi1", "1234!@#$", "단비", passwordEncoder::encode)
        ).isInstanceOf(IllegalArgumentException.class);
    }
}
